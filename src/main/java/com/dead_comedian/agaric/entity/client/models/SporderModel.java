...
public class SporderModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = body.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 0).addBox(-10.0F, -4.5F, -10.0F, 20.0F, 9.0F, 20.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -4.25F, 0.0F));
